    ...
    const handleFontSize = () => {
      window.requestAnimationFrame(() => {
        if (containerRef.current && headingRef.current) {
          ...
          const headingComputedStyle = window.getComputedStyle(
            headingRef.current,
            null
          );
          const headingFontSize =
            headingComputedStyle.getPropertyValue("font-size");
          const headingLetterSpacing =
            headingComputedStyle.getPropertyValue("letter-spacing");
